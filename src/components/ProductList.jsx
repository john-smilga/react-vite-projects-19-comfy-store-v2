      ...
      {products.map((product) => {
        ...
        return (
          <Link
            ...
            className='p-8 rounded-lg flex  flex-wrap bg-base-100 shadow-xl hover:shadow-2xl duration-300 group'
          >
            <img
              src={image}
              alt={title}
            ...
            <p className='font-medium ml-auto text-lg'>{formatPrice(price)}</p>
          </Link>
        );
